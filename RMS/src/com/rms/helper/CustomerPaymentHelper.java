...
import com.rms.dao.CreditCustBillDao;
import com.rms.dao.CustomerPaymentDao;
...
public class CustomerPaymentHelper {
	...
	public void regCreditCustomerCashBank(HttpServletRequest request,
		...
		SimpleDateFormat dateFormat1 = new SimpleDateFormat("yyyy-MM-dd");
			...
			com.rms.dao.CustomerPaymentDao dao = new CustomerPaymentDao();
	...
	public List getCreditCustomerBalanceReportNameWise(HttpServletRequest request,
			HttpServletResponse response) {
		String fkCustomerId = request.getParameter("fkCustomerId");
