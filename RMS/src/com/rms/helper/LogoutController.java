...
private static final long serialVersionUID = 1L;
	...
	public void logoutUser(HttpServletRequest request,HttpServletResponse response) throws IOException 
	{
		...
		out.println("alert('thanq you!!, Your session was destroyed successfully!! ++++ ++++  ');");
...
//		job.execute();
	...
	public boolean tbBackup(String dbName,String dbUserName, String dbPassword, String path) {
		...
		String executeCmd = "";
	    executeCmd = "C:/Program Files/MySQL/MySQL Server 5.7/bin/mysqldump -u " + dbUserName + " -p" + dbPassword + " --add-drop-database -B " + "rms" + " -r " + path;
	...
	public static void main1(){
	        ...
	        bb.tbBackup("rms","root","root","C:/dumpbackup/rms.sql");
