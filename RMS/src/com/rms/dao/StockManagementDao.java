...
public class StockManagementDao {
		...
		public void addStockIntoDatabase(StockManagementHibernate b) {
		...
		public List<StockEntryReportBean> getStockEntryReport() {
					...
					try
					{
						...
						hbu = HibernateUtility.getInstance();
					 session = hbu.getHibernateSession();
					 Query query2 = session.createSQLQuery("select product_name, supplier_name, buy_price, quantity, gst, gross_total from store_management");
