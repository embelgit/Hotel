	...
	<div id="start"> 
		<div class="row">
			<div class="col-md-6 col-lg-6 col-xl-6 col-sm-6">
				<div class="heading">	
					<h2 align="center" class="form-heading" ><b>Edit Supplier Details</b></h2>
				</div>
			</div>
		</div>
			...
			<form class="form-horizontal" name="editSupplier">
				<div class="row form-group"> 
					<div class="col-lg-12  col-md-12 col-sm-12 col-xs-12">	
						<div class="col-md-4  col-md-offset-1 col-sm-offset-1 col-sm-4 col-xs-4 col-xl-4 col-lg-4">
							...
							%>
								<input list="suplierName" id="fk_supplier_id" onchange="getSupplierDetails()" required>
				...
				<div class="row form-group"> 
					<div class="col-lg-12  col-md-12 col-sm-12 col-xs-12">	
						...
						<div class="col-md-4  col-md-offset-1 col-sm-offset-1 col-sm-4 col-xs-4 col-xl-4 col-lg-4">
							<div class="invoice_label_up">
				 				<input type="text" id='suplierContact' maxlength="10" name="suplierContact" required />
								<span></span>
				...
				<div class="ibutton" style="margin-bottom:50px">
					<div class="row" align="center">
						...
						<input type="button"  class="btn btn-lg btn-success btn-md" name="btn" value="Update" onclick="updateSupplierInfo()" />
