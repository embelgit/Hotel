<%@page import="com.rms.hibernate.stockReport"%>
<%@page import="com.rms.dao.GoodReceivedDao"%>
...
<body id="dt_example" style="min-height: 300px;">
	...
	<div class="row">
		<div align="center">
			<h2 class="form-name style_heading">Menu List</h2>
		</div>
	...
	<%
	GoodReceivedDao dao=new GoodReceivedDao();
	List list=dao.getStockList();
	%>
			...
			<tbody>
				<%
					for(int i=0;i<list.size();i++){
						stockReport sr=(stockReport)list.get(i);
				%>
