			...
			<form class="form-horizontal" action ="#" method ="post" name ="expenditurename">
					...
					<div class="col-lg-12  col-md-12 col-sm-12 col-xs-12">	
						<div class="col-md-4  col-md-offset-4 col-sm-offset-4 col-sm-4 col-xs-4 col-xl-4 col-lg-4">
							<div class="invoice_label_up">
						 		<input type="text" id="expenditurename" required />
								<span></span>
				...
				<div class="ibutton" style="margin-bottom:50px">
					<div class="row" align="center">
						...
						<input type="button" class="btn btn-lg btn-success btn-md" name="btn" value="Save" onclick="addexpenditure()" id="save"/> 
						...
						<input  type="button" value="List" id="listBtn" class="btn btn-lg btn-warning btn-md" onclick="listt()" />
					</div>
				</div>
			</form>
		</div>
