...
<div class="row">
	<div class="col-md-12 col-lg-4 col-xl-4 col-sm-12"></div>
				...
				<h2 align="center" class="form-heading"><b>Bank Details List</b></h2>
			</div>
...
<div class="col-md-12 col-lg-2 col-xl-2 col-sm-12">
	...
	List list12=dao.getAllbankForList(request);
				%>
			...
			<div class="table-responsive">
					...
					for(int i=0;i<list12.size();i++){
						bankdetailHibernate sr=(bankdetailHibernate)list12.get(i);
				%>
					...
					<tr>
						...
						<td class="align"><%=sr.getAccountname()%></td>
						<td class="align"><%=sr.getAccountnum()%></td>
