...
<%@page import="com.rms.dao.EmployeeDetailsDao"%>
<%@page import="com.rms.hibernate.EmployeeDetailsBean"%>
<%@page import="com.rms.dao.CustomerDetailsDao"%>
<%@page import="com.rms.dao.ExpenditureDetailsDao"%>
<%@page import="com.rms.hibernate.ExpenditureDetailsBean"%>
<%@page import="com.rms.hibernate.CustomerDetailsBean"%>
...
<link rel="stylesheet" href="/RMS/staticContent/css/tabDemo.css">

<script type="text/javascript"
	src="/RMS/staticContent/js/cashbankbook.js"></script>
			...
			<div class="col-md-12">
				...
				<div class="col-md-2">
					...
					<ul class="nav nav-tabs">
						...
						<li><a href="#messages" data-toggle="tab">Employee
								Payment</a></li>
	        		...
	        		$("#cheque_no").hide();
	            		...
	            		$("#card_no").hide(); 
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="input-group">
											<span class="input-group-addon"> Rs </span> <input
												id="supPay" name="supPay" class="form-control"
						...
						<div class="tab-pane" id="profile">
							<form class="form-horizontal" method="post" action="" name="cust">
								<div class="row">
									<div align="center">
										<h2 class="form-name style_heading">Credit Customer
											Payment</h2>
									</div>
							...
							%>
											<input list="cust_drop" id="creditCustomer"
												class="form-control" onchange="getBillByCustomer()">
				    		...
				    		%>
								...
								<div class="row form-group">
									<label class="col-md-3 control-label" for="bill_no">
										Bill No<sup>*</sup>
									</label>
									<div class="col-md-3">
										<div class="input-group">
	            		...
	            		$("#card_no1").hide(); 
								...
								<div class="row form-group">
									...
									<div class="col-md-5">
										<div class="input-group">
											<span class="input-group-addon"> Rs </span> <input
												id="custPay" name="custPay" class="form-control"
												placeholder="Enter Amount">
										</div>
									</div>
								</div>
						...
						<div class="tab-pane" id="messages">
							<form class="form-horizontal" method="post" action="" name="emp">
								...
								<div class="row form-group">
									...
									<label class="col-md-3 control-label" for="employeename">Waiter
										Name<sup>*</sup>
									</label>
									<div class="col-md-3">
										<div class="input-group">
				    		...
				    		%>
								...
								<div class="form-group row">
									<div class="col-md-10 text-center">
										...
										<input type="button" id="save" name="btn4"
											style="font-size: 25"
											class="btn btn-large btn-success button-height-width"
