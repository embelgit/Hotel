...
<script type="text/javascript"
	src="/SMT/staticContent/js/customerDetails.js"></script>
<script type="text/javascript">
	...
	<form class="form-horizontal" method="post" action="" name="cstd">
		...
		<fieldset>
			...
			<div class="row form-group">
				...
				<label class="col-md-2 control-label" for="aadharNo">GSTTIN/UIN
					No</label>
				<div class="col-md-3">
					<div class="input-group">
			...
			<div class="row form-group">
				<label class="col-md-2 control-label" for="emailId">Email ID
				</label>
				<div class="col-md-3 ">
					<div class="input-group">
						<span class="input-group-addon"> <i
				...
				<div class="col-md-3">
					<div class="input-group">
						<span class="input-group-addon"> <i
							class="	glyphicon glyphicon-envelope"></i>
						</span> <input id="zipCode" name="zipCode" placeholder="6 Digit Zip code"
							class="form-control input-md" type="text">
					</div>
				</div>
				...
				<div class="col-md-11 text-center">
              	...
              	<button class="btn btn-large btn-danger  button-height-width" type="reset"  onclick="reset()"><h4><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("cancel") %> <%}%> <%if(abc.equals("english")){%>Cancel<%}%> </h4> </button> --%>
					...
					<input type="button" id="save" name="btn" style="font-size: 25"
						...
						onclick="customerDetails()" value="Submit"> <input
						...
						style="font-size: 25" type="button" value="Credit Customer List"
						id="listBtn" class="btn btn-primary" onclick="Customerlist()" />
					<input style="font-size: 25" type="button" value="Edit"
						id="listBtn" class="btn btn-primary" onclick="editCustomer()" />
