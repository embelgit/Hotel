			...
			<form class="form-horizontal" name="editTableNumber">
				<div class="row form-group"> 
					<div class="col-lg-12  col-md-12 col-sm-12 col-xs-12">		
						<div class="col-md-4  col-md-offset-1 col-sm-offset-1 col-sm-4 col-xs-4 col-xl-4 col-lg-4">
							...
							%> 
								<input type="text" list="fk_table_id_drop1" id="fk_table_id" onchange="gettablenumbers()" autofocus="autofocus" required>
							 	<datalist id="fk_table_id_drop1">
							<%
								for(int i=0;i<iList.size();i++){
								   	kitchenorderHibernate bean = (kitchenorderHibernate) iList.get(i);
							%> 
									<option data-value="<%=bean.getPk_temp_id()%>" value="<%=bean.getTableNo()%>">
							<%
					           }
							%> 
								</datalist>
						...
						<div class="col-md-4  col-md-offset-1 col-sm-offset-1 col-sm-4 col-xs-4 col-xl-4 col-lg-4">
							<div class="invoice_label_up">
								<input type="number" name="tablename" id="tablename" required autofocus />
								<span></span>
				...
				<div class="ibutton" style="margin-bottom:50px">
					<div class="row" align="center">
						...
						<input  type="button" title="Submit filled Information" class="btn btn-lg btn-success btn-md" name="createbtn" value="Update" onclick="updateTable()" />		
						<i class="las la-angle-left la-2x cust"></i>
						<input  type="reset" title="Submit filled Information" class="btn btn-lg btn-primary btn-md" value="Back" onclick="back()"/>
					</div>	
				</div>
			</form>
		</div>
