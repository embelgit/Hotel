...
<div class="row">
	<div class="col-md-12 col-lg-4 col-xl-4 col-sm-12"></div>
			...
			<h2 align="center" class="form-heading"><b>Supplier List</b></h2>
		</div>
...
<input type="button"  value="Delete" id="listBtn" class="btn btn-lg btn btn-primary btn btn-primary" onclick="deleteList()"/>
