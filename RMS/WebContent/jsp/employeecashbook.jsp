		...
		<div class="form-background">
				...
				<div class="row form-group"> 
					<div class="col-lg-12  col-md-12 col-sm-12 col-xs-12">		
						<div class="col-md-4  col-md-offset-1 col-sm-offset-1 col-sm-4 col-xs-4 col-xl-4 col-lg-4">
							...
							%>
								<input list="waiterid_drop" id="waiterid" onchange="getEmpAmount()" required autofocus="autofocus">
			...
			<div class="ibutton" style="padding-bottom:50px;">
				<div class="row" align="center">
					...
					<input  type="button" class="btn btn-lg btn-success btn-md" name="saveButton" value="Save" onclick="validateCashBooknw()" id="buttonCSS"/> 
