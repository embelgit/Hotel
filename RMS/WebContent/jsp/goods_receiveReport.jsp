				...
				<div class="form-group">
					<div class="col-md-2 col-sm-offset-1" align="right">
						...
						GoodsReceiveDao Dao = new GoodsReceiveDao();
							List iList = Dao.getAllsupplierEntriesForOrderBill(request);
						%>
					</div>
					<div class="col-md-2 col-sm-3">
						<input list="fk_item_id_drop1" id="fk_item_id1" class="form-control" autofocus="autofocus">
						<datalist id="fk_item_id_drop1">

							<%
								for (int i = 0; i < iList.size(); i++) {
									SupplierDetailsHibernate itemEntry = (SupplierDetailsHibernate) iList.get(i);
							%>

							<option data-value="<%=itemEntry.getPkSupplierDetailId()%>"
								value="<%=itemEntry.getSuplierName()%>">
								<%
									}
								%>
