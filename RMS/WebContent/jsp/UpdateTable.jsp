...
<div class="row">
	<div class="col-md-12 col-lg-4 col-xl-4 col-sm-12"></div>
		...
		<h2 align="center" class="form-heading"><b>Move Table</b></h2>
		</div>
		<div class="col-md-12 col-lg-4 col-xl-4 col-sm-12"></div>
	</div>
		<form class="form-horizontal" action="#" method="post" name="movetable">
...
<div class="col-lg-12  col-md-12 col-sm-12 col-xs-12">		
			...
			<div class="invoice_label_up">
					...
					<%-- 	<%
						...
						<input list="fk_hotel_id_drop" id="fk_hotel_id"
							...
							<label>Selected Table Number :<sup> *</sup> </label>
						</div>
						</div>
			...
			<div class="invoice_label_up">
				...
				<label >Update Table Number  : <sup>*</sup> </label>
				</div>
