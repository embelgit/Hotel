...
<script src="/RMS/staticContent/js/supplier.js"></script>
		...
		<form action="supplier" name="supd" method="post"
			...
			<div class="row buttons_margin_top">
				<div align="center">
					...
					<input type="button" value="Edit Supplier"
						onclick="window.location.href='http://localhost:8080/SMT/jsp/s_SupplierEdit.jsp'"
