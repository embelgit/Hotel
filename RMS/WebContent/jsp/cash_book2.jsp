		...
		<div class="col-lg-12">
			...
			<div class="form-group-2">
				<div class="col-lg-12">
					...
					<div class="col-lg-2 col-md-1 col-sm-1 col-xs-6">
						<select id="paymenttonameid" onchange="cheak()"
							class="form-control">
							<option id="0" value="" selected="selected">Select To
								Pay</option>
				...
				<div class="col-lg-12">
					...
					<div class="col-lg-2 col-md-1 col-sm-1 col-xs-6">
						<input type="text" class="form-control" name="amount"
							id="paymentAmountId" placeholder="Paying Amount">
					</div>
				</div>
			</div>
				...
				<div class="col-lg-12">
					...
					<div class="col-lg-2 col-md-1 col-sm-1 col-xs-6">
						<input type="text" class="form-control" name="reason"
							id="paymentReasonId" placeholder="Payment Reason">
					</div>
				</div>
			</div>
