...
<%
	...
	//	double gstAmt = 0;
		...
		//	ResultSet rs = stmt.executeQuery("select c.TableNo, c.Itemname, c.Quantity, c.unitPrice, c.CurrentDate  from customerorder c where c.BillNo =" + billno);
			ResultSet rs = stmt.executeQuery("select c.TableNo, c.Itemname, c.Quantity, c.unitPrice, c.CurrentDate, c.GST, GridTotal from customerorder c where c.BillNo ='"+billno+"' and c.hotelid ='"+hotelid+"' and userid = '"+userid+"'");
