...
<script src="/RMS/staticContent/js/jquery-1.12.3.min.js"></script>
	...
	<script type="text/javascript">
	 function Back() {
			 window.location = "expenditure.jsp";
	}
...
<div class="row">
	<div class="col-md-12 col-lg-4 col-xl-4 col-sm-12"></div>
			<!-- 	<div class="col-md-12 col-lg-4 col-xl-4 col-sm-12">
				<h2 align="center" class="form-heading"><b>Expenditure List</b></h2>
			</div>
...
<div class="col-md-12 col-lg-4 col-xl-4 col-sm-12">
	...
	List list12=dao.getAllexpenditureForList(request);
	%>
			...
			<div class="table-responsive">
					...
					for(int i=0;i<list12.size();i++){
						expenditureHibernate sr=(expenditureHibernate)list12.get(i);
				%>
