...
<body id="dt_example">
	<div class="container-fluid">
		...
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading">Products Whose Quantity
					Less Than 10</h2>
			</div>
		</div>
		<%
		StockDao productForNotification = new StockDao();
		List<GetItemDetails> notificationProducts =productForNotification.getItemNameAndQuantityReport();
	%>
			...
			<div class="table-responsive" style="width: 900">
				<table class="table table-bordered table-striped table-condensed cf"
   			   ...
   			   for(int i=0;i<notificationProducts.size();i++){
   				GetItemDetails goodsForNotification =(GetItemDetails)notificationProducts.get(i);
				%>
