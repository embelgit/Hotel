...
<link rel="stylesheet" href="/RMS/staticContent/css/style.css">
	...
	<script type="text/javascript" src="/RMS/staticContent/js/orderBillTT.js"></script>
		...
		<!-- <h2 align="center" class="form-heading">Order Bill</h2> -->
			 ...
			 <div class="row margin-t-13">
					...
					<div class="col-md-1" align="right">
						...
						List waiterList= wList.getAllWaitersList();
			 ...
			 <h4 align="center" style="color: purple;">Ordered Items</h4> 
				...
				<div class="row">
					...
					<button class="btn btn-primary btn-lg"   onclick="listForOrderBill()" id="order" style="width:150px;">Order</button>
						<button class="btn btn-lg btn btn-success"  onclick="registerBill(); return false;" id="print" style="width:20%; margin-left:25px;">Print Bill</button>
<!-- 						<button class="btn btn-primary btn-lg"   onclick="listForOrderBill()" id="order" style="width:150px; margin-left:25px;">Order</button> -->
			...
			<h4 align="center" style="color: purple;">Select Table</h4>
				<div class="row" align="center">		
					<div>		
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="1" onclick=" getItemDetailById1(this); return false;"><h3>Pasta</h3></button>					
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="2" onclick=" getItemDetailById1(this); return false;"><h3>Cocacola</h3></button>
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="3" onclick=" getItemDetailById1(this); return false;"><h3>Pizza</h3></button>
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="4" onclick=" getItemDetailById1(this); return false;"><h3>Burger</h3></button>
					</div>
				</div>
				
				 <div class="row" align="center">		
					<div style="padding-top: 15px;">		
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="5" onclick="  getItemDetailById1(this); return false;"><h4>Biryani</h4></button>					
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="6" onclick="  getItemDetailById1(this); return false;"><h4>Mirinda</h4></button>
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="7" onclick="  getItemDetailById1(this); return false;"><h4>Thunsup</h4></button>
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="8" onclick="  getItemDetailById1(this); return false;"><h4>Redbull</h4></button>
					</div>
				</div>
				...
				<div class="row" align="center">		
					<div style="padding-top: 15px;">
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="9" onclick=" getItemDetailById1(this); return false;"><h4>Milkshake</h4></button>					
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="10" onclick=" getItemDetailById1(this); return false;"><h4>MountainDew</h3></button>
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="11" onclick=" getItemDetailById1(this); return false;"><h4>French fries</h4></button>
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="12" onclick=" getItemDetailById1(this); return false;"><h4>Paneer Chilly</h4></button>
					</div>
				</div>
				
		<!-- 		<div class="row" align="center">		
					<div style="padding-top: 15px;">		
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="13" onclick=" getItemDetailById1(this); return false;"><h3>Mcflury</h3></button>					
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="14" onclick=" getItemDetailById1(this); return false;"><h3>Tea</h3></button>
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="15" onclick=" getItemDetailById1(this); return false;"><h3>Dosa</h3></button>
						<button class="btn btn-primary" name="p" id="table_No" style="height:100px;width:100px;padding: 10px;" value="16" onclick=" getItemDetailById1(this); return false;"><h3>Sarbat</h3></button>
					</div>
				</div>
