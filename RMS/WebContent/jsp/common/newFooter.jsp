...
.gradient h2 {
	color: #117FB2;
	-webkit-mask-box-image: -webkit-gradient(linear, left top, left bottom, color-stop(20%, rgba(0,
		0, 0, 1)), color-stop(100%, rgba(0, 0, 0, 0)));
}
</style>
...
<body>
	<div class="fluid-container">
		<div class="row footer navbar-fixed-bottom"
			style="background-color: #8c7674;">
			<!-- <div class="col-md-12" class="row footer navbar-fixed-bottom" style="background-color:#8c7674;"> -->
			<!-- <div class="table-responsive"> -->
			<marquee onmouseover="this.stop()" onmouseout="this.start()"
				scrollamount="4" style="height: 45px;">
				<h3 style="color: greenyellow;">Embel Technologies
					Pvt.Ltd.,Pune. Contact Number: 8275941044</h3>
				<!-- 			   <table class="table">
				<tbody>
					<tr>
						 <div class="btn-group">
...
<body>
<div class="footer" >
  <p style="hei"><b>Copyright © <%=year%> Embel Technology Pvt. Ltd.<br/><a href="http://www.embel.co.in" style="color: orange;"><p style="font-size: 18px">www.embel.co.in</p></a></b></p>
</div>
