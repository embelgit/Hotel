...
<body>
	...
	<div class="container-fluid">
		...
		<form class="form-horizontal" name="editItemDetails">

			<div class="row">
				<div class="form-group">
					<div class="col-sm-2 col-sm-offset-1" align="right">
						<label class="control-label">Select item Name</label>
					</div>
					<div class="col-md-3">
						<div class="input-group">
							...
							<input list="fk_item_id_drop" id="fk_item_id"
								class="form-control" onchange="getItemDetails()">
			...
			<div class="row buttons_margin_top">
				<div align="center">
					<input type="button"
						...
						name="btn" value="Save" onclick="updateItemDetailsInfo()" /> <input
